...
int main() {
    ...
    float altura[] = {1.55, 1.59, 1.6, 1.73, 1.65, 1.8, 1.58, 1.69, 1.6, 1.6, 1.9, 1.89, 1.73, 1.54, 1.55, 1.72, 1.63, 1.75, 1.8, 1.8, 1.8, 1.62, 1.69, 1.68, 1.58, 1.8, 1.5, 1.67, 1.78, 1.86, 1.8, 1.7};
    // 5. Escuela
